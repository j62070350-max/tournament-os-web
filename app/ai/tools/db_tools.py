...
class AIDBTools:
    ...
    async def get_tournament_info(self) -> dict:
        ...
        return {
            ...
            "channel_config": t.channel_config or {},
        }

    async def get_match_channel(self, match_id: str) -> str | None:
        """Returns the Discord channel ID for a specific match."""
        from app.database.models.match import Match
        q = (
            select(Match.private_channel_id)
